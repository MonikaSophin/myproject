...
import static com.ToStringUtils.ToStringTokenUtils.parseToken;
import static com.ToStringUtils.ToStringTokenUtils.splitToken;
...
public class ToStringUtils {
	...
	public static void main(String[] args) {
		String s = "[QueryReviewDataReqDTO(super=AgenAuthBaseReqDTO(account=18606205010, accountType=EMPLOYEE_ACCOUNT, operator=18606205010, ip=172.17.47.142, traceLogId=160678726042522649, provinceCode=null, cityCode=null, requestSystem=null, requestChannel=null), id=312)";
		String s1 = toJSONString(s);
