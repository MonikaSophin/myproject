 ...
 * 练习24：模仿SimpleHashMap.java的例子，写一个SimpleHashSet，并做测试。
 */
class SimpleHashSet24<E> implements Set<E> {
    ...
    // 有三种方法可以帮助进行适当的迭代 by SimpleHashSet.iterator():
 ...
 * After String[] sa = new String[3], shs.toArray(sa), sa holds: pie hi there
 */